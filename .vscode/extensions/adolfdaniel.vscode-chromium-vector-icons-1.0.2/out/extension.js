...
function showPanel(editor, extensionUri) {
    ...
    if (panel) {
        ...
        panel = vscode.window.createWebviewPanel('previewingVectorIcon', `Previewing ${path.basename(editor.document.fileName)}`, {
...
function onActiveEditorChanged(editor, extensionUri) {
    if (!editor) {
        return;
    }
    if (!panel) {
